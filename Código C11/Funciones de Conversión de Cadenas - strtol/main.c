/* Función strtol() - Convierte en una valor long int una secuencia de caracteres que representan un número entero.

La función devuelve 0 si no puede convertir ninguna parte de su primer argumento a long int.
...
int main(void) {
	...
	long x = strtol(cadena, &residuoPtr, 0);
