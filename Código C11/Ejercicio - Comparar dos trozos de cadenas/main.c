/*
Ejercicio - Comparar dos trozos de dos cadenas introducidas por el usuario

El programa debe indicar si el trozo de la primera cadena es menor, igual o mayor que el trozo de la segunda cadena.
*/
...
int main(void) {
	...
	unsigned int numCaracteresAComparar = 0;
	...
	printf("\nIntroduzca a continuacion el numero de caracteres para ser comparado en ambas cadenas: ");
	scanf_s("%u", &numCaracteresAComparar);
	...
	if (strncmp(cadena1, cadena2, numCaracteresAComparar) == 0) {
