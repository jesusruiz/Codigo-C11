/*
Leyendo datos desde un Archivo secuencial con fgetc() e imprimiendo los datos por pantalla

Prototipo de la función:
char fgetc(FILE *archivo);

Esta función se usa generalmente para recorrer archivos de texto completos.
