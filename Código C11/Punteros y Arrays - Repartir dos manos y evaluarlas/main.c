//Punteros y Arrays - Barajar un mazo de cartas, simular el reparto de dos manos, clasificar las dos manos 
//y evaluarlas para conocer cuál es la mejor de las dos
